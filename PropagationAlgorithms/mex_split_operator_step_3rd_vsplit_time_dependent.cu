...
int main(double t_query,myComplex *dev_expv,double *dev_z_offset,double *dev_gauss_pos,double *dev_x0,double *dev_y0,myComplex *dev_expk,myComplex *dev_psi,int nx,int ny,int nz,int decay_type,double A,double eV,double h_bar,double dt,double dx,double dy,double dz,int iteration,const mwSize* gauss_dims) {
