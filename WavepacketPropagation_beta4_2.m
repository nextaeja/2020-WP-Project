...
%===RUN=SIMULATION======================================================================================%
    ...
    if(propagationMethod==6)
        for i=1:numGfxToSave
            ...
            mexcudawhile(exp_v_ptr, z_offset_ptr, gauss_position_ptr, x0_ptr, y0_ptr, exp_k_ptr, psi_ptr, nx, ny, nz, decayType, A, eV, hBar, dt, dx, dy, dz, gfxSteps,t,alpha,numAdsorbates, numIterations);%possibly add epsilon          
